...
questao&cpl=q1&id=<?PHP echo($idq);?>&idc=<?php echo($id);?>'><?PHP echo($id);?></td>
...
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=questao&cpl=q1&idc=<?php echo($id); ?>'>Próximos</a></td>
		<?php	
		}else{
			$_SESSION['inicial']=0;
		}
