...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Consulta Requisições - Triagem: Selecione parâmetros</p>
			<br>
			<div class="row">
...
-->
		...
		<td><?PHP echo($guia);?></td>
        <td><a href='chameFormulario.php?op=cadastrar&obj=triagem&cpl=t1&id=<?PHP echo($id);?>'>Ver</a></td>
    </tr>
<?php
	}
}
?>
	...
	<tr>
		...
		?>
		<td><a href=		<td><a href='chameFormulario.php?op=consultar&obj=requisicao&cpl=t1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
