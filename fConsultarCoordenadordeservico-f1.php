...
$vez=0;
$rotina='fConsultarCoordenadordeservico-f1.php';
...
//	echo('aqui 3:'.$textopesquisa);
	$reclst=fpesquisacoordenadordeservico_fi($textopesquisa,$conefi);
...
if(!$leu){$_SESSION['rotina']='xxx'; //echo('<br>nao leu<br>');
}
// Área de PK
$pvez=true;
?>
...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Digite o texto a pesquisar no nome (Arquivo de Coordenador de Serviços): </p><br>
			<div class="input0">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=consultar&obj=pessoa_coordenadordeservico&cpl=f1" > Cadastrar Coordenador de Serviço<a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="rCoordenadordeservico01.php" target="_new" > Relação Geral de Coordenadores de Serviço</a>
			</div>
			<br><br>
		</form>
	<br>
...
?>
	...
	<tr>
		...
		<th width='35%'>Nome</th>
		<th width='10%'>CPF</th>
		<th width='10%'>CREFITO</th>
		<th width='30%'>Serviço/Área</th>
		<th width='5%'>Ativo?</th>
		<th width='10%'>Ação</th>
	</tr>
<?php
...
Coordenadordeservico&&cpl=f1&id=<?PHP echo($pid);?>&idc=<?PHP echo($coordenadordeservicoid);?>'><?PHP echo($coordenadordeservicoid);?></td>
		<td><?PHP echo($nome);?></td>
...
?>			
		<td><a href='chameFormulario.php?op=cadastrar&obj=
		Coordenadordeservico&cpl=f1&id=<?PHP echo($pid);?>&idc=<?PHP echo($coordenadordeservicoid);?>&del=<?php echo('des');?>'><?PHP echo('Desativa');?></a></td>
<?php 
}else{
?>
		<td><a href='chameFormulario.php?op=cadastrar&obj=
		Coordenadordeservico&cpl=f1&id=<?PHP echo($pid);?>&idc=<?PHP echo($coordenadordeservicoid);?>&del=<?php echo('ati');?>'><?PHP echo('Ativa');?></a></td>
<?php
}
?>
		<td><a href='chameFormulario.php?op=cadastrar&obj=
		Coordenadordeservico&cpl=f1&id=<?PHP echo($pid);?>&idc=<?PHP echo($coordenadordeservicoid);?>&del=<?php echo('del');?>'><?PHP echo('Exc');?></a></td>
    </tr>
<?php
	}
}
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=Coordenadordeservico&cpl=f1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
