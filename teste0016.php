...
?>
<div>
	<input type="checkbox" id="campo1" name="campo1" value="1" <?php if(!is_null($v1)) echo('checked');?>>
	<label for="campo1">Opção 1</label>	
	<input type="checkbox" id="campo2" name="campo2" value="2" <?php if(!is_null($v2)) echo('checked');?>>
	<label for="campo2">Opção 2</label>	
	<input type="checkbox" id="campo3" name="campo3" value="3" <?php if(!is_null($v3)) echo('checked');?>>
