...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Cadastro de FISIOTERAPEUTAS</p>
			<p>Digite o nome ou parte do nome do fisioterapeuta a ser cadastrado: </p><br>
			<div class="input0">
			<input class="inputpesquisa" type='text' name='textopesquisa' id='ipesquisa' value=" " />
			<button type="button" id="ibotao" class="lupa"></button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=cadastrar&obj=pessoa&cpl=p1" > Cadastrar Paciente/Pessoa<a>
...
Pessoa&cpl=p1&id=<?PHP echo($pessoaid);?>'><?PHP echo($pessoaid);?></a></td>
		...
		<td><a href='chameFormulario.php?op=cadastrar&obj=fisioterapeuta&cpl=f1&id=<?PHP echo($pessoaid);?>'><?PHP echo('Fisioterapeuta');?></a></td>
    </tr>
<?php
	}
}
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=pessoa_fisioterapeuta&cpl=f1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
