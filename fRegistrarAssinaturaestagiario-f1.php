...
$t=ftrace('fRegistrarAssinaturaestagiario-f1.php','pessoaid='.$usuarioid.' agendaid='.$agendaid.' grupo='.$grupo);
...
$act="registrarAssinaturaestagiario-f1.php?id=$qaid";
...
if($statusagenda<2){
	if($grupo == 'esa'){
?>					
					<td><a href='chameFormulario.php?op=registrar&obj=assinaturaestagiario&cpl=f1&id=<?PHP echo($sid);?>'><?PHP echo($estagiarioassinante);?></a></td>
<?php
	}else{
?>		
...
<?php
	if($grupo == 'coa'){
?>					
					<td><a href='chameFormulario.php?op=registrar&obj=professorautorizador&cpl=f1&id=<?PHP echo($sid);?>'><?PHP echo($professorautorizador);?></a></td>
<?php
	}else{
?>		
