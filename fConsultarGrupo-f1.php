...
//	echo('aqui 3:'.$textopesquisa);
	$reclst=fpesquisadescricao('grupo',$textopesquisa,$conefi);
...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Grupo de Usuário - Digite o texto a pesquisar: </p><br>
			<div class="input0">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=cadastrar&obj=grupo&cpl=f1" > Cadastrar Grupo de Usuário</a>
			</div>
			<br>
		</form>
	<br>
...
grupo&cpl=f1&id=<?PHP echo($id);?>'><?PHP echo($id);?></td>
		<td><?PHP echo($grupo);?></td>
		<td><?PHP echo($descricao);?></td>
		<td><a href='chameFormulario.php?op=cadastrar&obj=
grupo&cpl=f1&id=<?PHP echo($id);?>&del=<?php echo('del');?>'><?PHP echo('Exc');?></a></td>
    </tr>
<?php
	}
}	
...
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=grupo&cpl=f1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
