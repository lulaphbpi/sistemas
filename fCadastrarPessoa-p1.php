...
//die($act);
?>
<!-- <script type="text/javascript">window.onload = function(){document.getElementById('cpf').focus();}</script> -->
...
?>
				...
				<div class="form-group col-md-3">
				<label>Vínculo com a UFDPar:</label>
...
?>
            ...
            <input type="date" id="datanascimento" name="datanascimento" size="10" maxlength="10" class="form-control" value='<?php echo($datanascimento);?>' required>
				</div>
				<div class="form-group col-md-3">
...
?>
			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					...
					<input type="text" id="complemento" name="complemento" size="99" maxlength="120" class="form-control" value='<?php echo($complemento);?>'>
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-4">
					<label>Bairro (*):</label>
					<input type="text" id="bairro" name="bairro" size="30" maxlength="30" class="form-control" value='<?php echo($bairro);?>'>
				</div>
				<div class="form-group col-md-3">
					<label>Cidade (*):</label>
...
?>
				...
				<div class="form-group col-md-2">
					<label>Cep:</label>
					<input type="text" id="cep" name="cep" size="10" maxlength="10" class="form-control" value='<?php echo($cep);?>'>
				</div>
			</div>
			<div class="row">
            ...
            <input type="text" id="fone" name="fone" size="99" maxlength="120" class="form-control" required value='<?php echo($fone);?>'>
				...
				<div class="form-group col-md-5">
			<label>E-mail (preferencialmente Institucional, se for da UFDPar):</label>
            <input type="email" id="email" name="email" size="99" maxlength="120" class="form-control" value='<?php echo($email);?>'>
				</div>
			</div>
			...
			<div class="row">
				...
				<button type="submit" id="ibformulariop1" style="width:90;height:20" class="btn btn-primary btn-block"> <?php echo($operacao);?> </button>
				</div>
			</div>	
        </form>    
<?php 
...
cliente&cpl=p2&id=<?PHP echo($id);?>'><?PHP echo('Ver Paciente');?></a
...
?>	
	<a href='chameFormulario.php?op=iniciar&obj=sistema'>Cancelar</a>
