...
$nome='';
$dataf=date('Y-m-d');
$datai=convertestringparadata('2000-01-01');
//echo(' 1 Data I:'.$datai.' Data F:'.$dataf.'<br>');
$contador=0;
if(isset($_POST['nome'])){
	$nome=trim(addslashes($_POST['nome']));
	$datai=$_POST['datai'];
	$dataf=$_POST['dataf'];
//echo(' 2 Data I:'.$datai.' Data F:'.$dataf.'<br>');
...
//echo(' 3 Data I:'.$datai.' Data F:'.$dataf.' '.$_SESSION['inicial'].'<br>');
	}}
}
//die(' 4 Data I:'.$datai.' Data F:'.$dataf);
// Área de PK
//$msg="Mensagem:".$msg;
$pvez=true;
?>
...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Consulta Requisições - Selecione parâmetros</p>
			<br>
			<div class="row">
...
-->
		...
		<td><?PHP echo($guia);?></td>
        <td><a href='chameFormulario.php?op=cadastrar&obj=requisicao&cpl=r1&id=<?PHP echo($pessoaid);?>&idc=<?PHP echo($id);?>'>Ver</a></td>
    </tr>
<?php
	}
}
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=requisicao&cpl=r1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
