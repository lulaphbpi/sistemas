...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Digite o nome ou parte do nome do médico a ser cadastrado: </p><br>
			<div class="input0">
...
Pessoa&cpl=p1&id=<?PHP echo($pessoaid);?>'><?PHP echo($pessoaid);?></a></td>
		...
		<td><a href='chameFormulario.php?op=cadastrar&obj=medico&cpl=f1&id=<?PHP echo($pessoaid);?>'><?PHP echo('Médico');?></a></td>
    </tr>
<?php
	}
}
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=pessoa_medico&cpl=f1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
