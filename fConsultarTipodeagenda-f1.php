...
$rotina='fConsultarTipodeservico-f1.php';
...
if(isset($_GET['idx']) && empty($_GET['idx']) == false){
	...
	if(strlen($tx)>1)
		$tx=trim($tx);
	$reclst=fpesquisatipodeagenda_fi($tx,$conefe);
	if(!$reclst)
		die($_SESSION['msg']);
...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Tipo de Agenda - Digite o texto a pesquisar: </p><br>
			<div class="input0">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=cadastrar&obj=tipodeagenda&cpl=f1" > Cadastrar Tipo de Agenda</a>
			</div>
			<br>
		</form>
	<br>
...
tipodeagenda&cpl=f1&id=<?PHP echo($id);?>'><?PHP echo($id);?></td>
		<td><?PHP echo($descricao);?></td>
		<td><a href='chameFormulario.php?op=cadastrar&obj=
tipodeagenda&cpl=f1&id=<?PHP echo($id);?>&del=<?php echo('del');?>'><?PHP echo('Exc');?></a></td>
    </tr>
<?php
	}
}	
...
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=tipodeagenda&cpl=f1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
