...
if(isset($_POST['textopesquisa']) && empty($_POST['textopesquisa']) == false){
	...
	if(strlen($tx)>1)
		$tx=trim($tx);
	$reclst=fpesquisadescricao('convenio',$tx,$conacl);
	if(!$reclst)
		die($_SESSION['msg']);
...
<div class="areatrabalho">
	...
	<div class="areareduzida">
        <form action="" method="post" id="iformulario" class="formulario">
			...
			<p>Digite o texto a pesquisar no nome (Arquivo de Convênios): </p><br>
			<div class="input0">
			<input class="inputpesquisa" type='text' name='textopesquisa' id='ipesquisa' value=" " />
			<button type="button" id="ibotao" class="lupa"></button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=cadastrar&obj=convenio&cpl=v1" > Cadastrar Convênio<a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="rconvenio01.php" target="_new" > Relação Geral de Convênios</a>
			</div>
			<br><br>
		</form>
	<br>
...
convenio&&cpl=v1&id=<?PHP echo($id);?>'><?PHP echo($id);?></td>
...
?>
	...
	<tr>
		...
		?>
		<td><a href='chameFormulario.php?op=consultar&obj=convenio&cpl=v1&id=<?php echo($ord); ?>'>Próximos</a></td>
		<?php	
		}
		?>
	</tr>	
