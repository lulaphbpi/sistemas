...
$act=lcfirst($operacao).'Tabela-t1.php';
if($id>0){
	$operacao='Atualizar';
	$act=$act.'?id='.$id;
	$rtab=letabelaporid($tabela,$id,$conacl);
	if($rtab){
		$id=$rtab['id'];
...
if($id>0){
?>	
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=cadastrar&obj=tabela&cpl=t1" > Cadastrar <?php echo($tabela);?><a>		
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="chameFormulario.php?op=consultar&obj=tabela&cpl=t1" > Consultar <?php echo($tabela);?><a>		
<?php
}
?>
    </div>    
